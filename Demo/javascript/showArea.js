...
document.querySelector('.top-area-pro ul').addEventListener('touchend',function (e) {
    e.stopPropagation();
    cityEle.innerHTML='';
    countyEle.innerHTML='';
...
document.querySelector('.top-area-city ul').addEventListener('touchend',function (e) {
    e.stopPropagation();
    countyEle.innerHTML='';
    var proIndex=e.target.getAttribute('data-index');
...
document.querySelector('.top-area-county ul').addEventListener('touchend',function (e) {
    e.stopPropagation();
